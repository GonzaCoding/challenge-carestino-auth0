    ...
    'security' => [
        ...
        */
        ...
        'oauth2_security_example' => [ // Unique name of security
            ...
            'description' => 'OAuth local.',
            'flow' => 'implicit', // The flow used by the OAuth2 security scheme. Valid values are "implicit", "password", "application" or "accessCode".
            'authorizationUrl' => 'http://localhost:80/api/auth', // The authorization URL to be used for (implicit/accessCode)
            'tokenUrl' => 'http://localhost:80/api/auth' // The authorization URL to be used for (password/application/accessCode)
            'scopes' => [
